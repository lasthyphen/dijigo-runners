...
then
    ...
    # https://github.com/lasthyphen/beacongo/releases
    GOARCH=$(go env GOARCH)
    GOOS=$(go env GOOS)
    DOWNLOAD_URL=https://github.com/lasthyphen/beacongo/releases/download/v${VERSION_1}/avalanchego-linux-${GOARCH}-v${VERSION_1}.tar.gz
    DOWNLOAD_PATH=/tmp/avalanchego.tar.gz
    if [[ ${GOOS} == "darwin" ]]; then
      DOWNLOAD_URL=https://github.com/lasthyphen/beacongo/releases/download/v${VERSION_1}/avalanchego-macos-v${VERSION_1}.zip
...
then
    ...
    # download avalanchego
    # https://github.com/lasthyphen/beacongo/releases
    DOWNLOAD_URL=https://github.com/lasthyphen/beacongo/releases/download/v${VERSION_2}/avalanchego-linux-${GOARCH}-v${VERSION_2}.tar.gz
    if [[ ${GOOS} == "darwin" ]]; then
      DOWNLOAD_URL=https://github.com/lasthyphen/beacongo/releases/download/v${VERSION_2}/avalanchego-macos-v${VERSION_2}.zip
      DOWNLOAD_PATH=/tmp/avalanchego.zip
    fi
